...
export function TonightStrip({ locale }: { locale: Locale }) {
  ...
  return (
    <section aria-label={messages.tonight.heading} className="border-b border-gold/25 bg-espresso/55">
      <div className="mundus-container flex flex-col gap-6 py-7 sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:py-8">
        <div className="flex items-start gap-4">
          <span aria-hidden="true" className="mt-1 text-2xl leading-none text-gold">✳</span>
          <div>
            <h2 className="font-display text-2xl font-[300] tracking-[-0.035em] text-cream sm:text-3xl">
            ...
            <p className="mt-1 text-sm text-cream/70 sm:text-base">
              ...
              <span aria-hidden="true" className="mx-2 text-gold/70">·</span>
